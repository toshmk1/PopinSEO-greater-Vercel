...
const WhyChooseUsSection = () => {
  ...
  return (
    <section className="relative">
      {/* Section Header */}
      <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden px-4 sm:px-6 lg:px-8 snap-section">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-golden/3 to-transparent"></div>
        <motion.div 
          ref={ref}
          className="text-center z-10 max-w-6xl w-full"
          initial={{ opacity: 0, y: 50 }}
        ...
        >
          ...
          <motion.p 
            ...
            transition={{ duration: 0.8, delay: 0.6 }}
          >
            From attracting creators to monetizing traffic
          </motion.p>
          ...
          {index < 4 && (
            ...
            >
              <motion.div
                ...
                className="flex flex-col items-center text-white/60"
              >
                <span className="text-xs sm:text-sm mb-2 tracking-wider">CONTINUE</span>
                <div className="w-px h-12 sm:h-16 bg-gradient-to-b from-white/60 to-transparent"></div>
              </motion.div>
            </motion.div>
          )}
